...
//     version 1.7.0
//     from Assets/Input/InputActions_Skyborne.inputactions
//
...
public partial class @InputActions_Skyborne: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_Skyborne()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputActions_Skyborne"",
    ""maps"": [
        {
            ""name"": ""Aircraft"",
    ...
    {
        private @InputActions_Skyborne m_Wrapper;
        public UIActions(@InputActions_Skyborne wrapper) { m_Wrapper = wrapper; }
